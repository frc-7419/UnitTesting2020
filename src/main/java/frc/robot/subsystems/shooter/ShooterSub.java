...
public class ShooterSub extends SubsystemBase{
    ...
    private double powerMultipler = 1;
    ...
    public void stuckMode(){this.powerMultipler = 2;}
    public void unstuckMode(){this.powerMultipler = 1;}
    public double getPowerMultiplier(){return this.powerMultipler;}
}